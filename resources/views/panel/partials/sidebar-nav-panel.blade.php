    ...
    $ysbGroups = [
        ...
        [
            ...
            'items' => [
                ...
                ['href' => $has('blog') ? route('panel.bloglar') : $paketUyari, 'match' => 'panel.bloglar*', 'label' => 'Blog Yazilarim', 'locked' => ! $has('blog')],
                ...
                ['href' => route('panel.yorumlar'), 'match' => 'panel.yorumlar*', 'label' => 'Hasta Yorumlari'],
                ['href' => $has('faq') ? route('panel.faqs') : $paketUyari, 'match' => 'panel.faqs*', 'label' => 'SSS', 'locked' => ! $has('faq')],
                ['href' => $has('galeri') ? route('panel.galeri') : $paketUyari, 'match' => 'panel.galeri*', 'label' => 'Fotograf Galerisi', 'locked' => ! $has('galeri')],
