...
<html lang="tr">
<head>
    @include('frontend.themes.tema-2.layouts.partials.head')
</head>
@php
...
<body class="theme-{{ $bodyTema }} layout-tema-2">
    ...
    @include('frontend.themes.tema-2.layouts.partials.footer', ['doktor' => $doktor ?? [], 'nav' => $nav])
    @include('frontend.themes.tema-2.layouts.partials.script', ['doktor' => $doktor ?? []])
</body>
</html>
