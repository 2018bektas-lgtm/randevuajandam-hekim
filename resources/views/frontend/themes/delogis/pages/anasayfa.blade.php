{{--
    Anasayfa — Delogis (tema-4..9, modüler render)

    Modüller sırası + aktiflik + özel ayarlar DB'de (site_homepage_sections).
    Config: config/delogis_tema.php (tema_modulleri.php içinden yüklenir)
    Render: App\Services\SiteBuilderService::renderIcinModuller()
--}}
