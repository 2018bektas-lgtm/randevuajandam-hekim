...
<div class="max-w-3xl space-y-5">
    ...
    <div class="bg-slate-50 border border-slate-200 rounded-2xl p-5 text-xs text-slate-600 leading-relaxed">
        ...
        Site logosu, menü, slider ve SEO ayarları bu sitenin kendi veritabanındadır; API olmadan da yönetilir.
        Randevu, hizmet, blog ve finans verileri ana platform API’sinden gelir.
    </div>
</div>
@endsection
