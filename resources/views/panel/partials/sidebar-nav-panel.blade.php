@php
    ...
    $ysbGroups = [
        ...
        [
            ...
            'items' => [
                ['href' => $r('panel.site-ayarlari.genel'), 'match' => 'panel.site-ayarlari.genel', 'label' => 'Genel Bilgiler'],
                ['href' => $r('panel.site-ayarlari.temalar'), 'match' => 'panel.site-ayarlari.temalar', 'label' => 'Tema Seçimi'],
                ['href' => $r('panel.sayfa-builder.index'), 'match' => 'panel.sayfa-builder*', 'label' => 'Ana Sayfa Tasarımı'],
                ['href' => $r('panel.sayfa-icerikleri.index'), 'match' => 'panel.sayfa-icerikleri*', 'label' => 'Sayfa Başlıkları & Bannerlar'],
                ...
                ['href' => $r('panel.site-ayarlari.sayfalar'), 'match' => 'panel.site-ayarlari.sayfalar*', 'label' => 'Ek Sayfalar (Özel)'],
            ],
        ],
        [
            'id' => 'finans',
