...
class SiteAyarlariController extends Controller
{
    ...
    public function kaydetTema(Request $request)
    {
        ...
        if (! theme_is_available($data['tema_id'])) {
            return back()->with('hata', 'Bu premium tema web sitesi paketinde yer alır. Lütfen paketinizi yükseltin veya ücretsiz bir tema seçin.');
        }
     ...
     * Dolu menüye zorla yeni satır eklemez (kullanıcı silmiş olabilir).
     */
