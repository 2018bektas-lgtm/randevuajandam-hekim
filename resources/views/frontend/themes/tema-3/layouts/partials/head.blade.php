...
<link rel="stylesheet" href="{{ asset('vendor/hipno/css/bootstrap.min.css') }}">
<link rel="stylesheet" href="{{ asset('vendor/hipno/css/slicknav.min.css') }}">
<link rel="stylesheet" href="{{ asset('vendor/hipno/css/swiper-bundle.min.css') }}">
