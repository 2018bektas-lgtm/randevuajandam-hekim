...
Route::controller(SiteController::class)->group(function () {
    ...
    Route::get('/hakkimda', 'hakkimda')->name('frontend.hakkimda');
    ...
    Route::get('/egitimler', 'egitimler')->name('frontend.egitimler');
...
// Misafir randevu — sunucu proxy (API secret tarayıcıya gitmez)
Route::prefix('site-api/booking')
    ...
    ->group(function () {
        ...
        Route::post('/appointments', [BookingProxyController::class, 'storeAppointment'])
            ...
            ->name('appointments');
        Route::post('/educations/apply', [BookingProxyController::class, 'storeEducationApplication'])
            ->middleware('throttle:10,1')
            ->name('educations.apply');
    });
...
Route::prefix('yonetim')->name('panel.')->group(function () {
    ...
    Route::middleware('panel.auth')->group(function () {
        ...
        Route::middleware('panel.api')->group(function () {
            ...
            Route::middleware('panel.paket:randevu_talepleri,randevu_talebi_goruntule')->group(function () {
