...
$delogisModuller = [
    'hero' => [
        ...
        'alanlar' => [
            ...
            'aciklama' => ['tip' => 'uzun_metin', 'label' => 'Açıklama', 'varsayilan' => 'Bireysel, çift ve aile danışmanlığı ile yanınızdayım.'],
    ...
    'about' => [
        ...
        'alanlar' => [
            ...
            'aciklama' => ['tip' => 'uzun_metin', 'label' => 'Açıklama', 'varsayilan' => 'Danışanlarımın hayatlarında kalıcı değişimler yaratmayı hedefliyorum.'],
            'deneyim_sayi' => ['tip' => 'sayi', 'label' => 'Deneyim yılı (0=gizle)', 'varsayilan' => 10],
            'deneyim_etiket' => ['tip' => 'metin', 'label' => 'Deneyim etiketi', 'varsayilan' => "Yıllık\nDeneyim"],
            'maddeler' => ['tip' => 'liste', 'label' => 'Maddeler (satır satır)', 'varsayilan' => "Şefkatli ve yargısız alan\nKanıta dayalı yaklaşım\nGizlilik ve güven\nOnline ve yüz yüze seans"],
    ...
    'counters' => [
        ...
        'alanlar' => [
            ...
            'buton_metin' => ['tip' => 'metin', 'label' => 'Buton', 'varsayilan' => 'Randevu Al'],
            'sayac_1_sayi' => ['tip' => 'sayi', 'label' => 'Sayaç 1', 'varsayilan' => 200],
            'sayac_1_etiket' => ['tip' => 'metin', 'label' => 'Sayaç 1 etiket', 'varsayilan' => 'Mutlu danışan'],
            'sayac_2_sayi' => ['tip' => 'sayi', 'label' => 'Sayaç 2', 'varsayilan' => 97],
            'sayac_2_etiket' => ['tip' => 'metin', 'label' => 'Sayaç 2 etiket', 'varsayilan' => 'Memnuniyet %'],
            'sayac_3_sayi' => ['tip' => 'sayi', 'label' => 'Sayaç 3', 'varsayilan' => 12],
