...
<div class="w-full max-w-md">
    <div class="text-center mb-6">
        ...
        <h1 class="mt-4 font-display text-2xl font-bold text-slate-900">Hekim Yönetim Girişi</h1>
        <p class="mt-2 text-sm text-slate-500">
            Platform senkronu için ana sunucu hekim hesabı.
            API bozuksa yerel admin ile panele girip anahtarı düzeltebilirsiniz.
        </p>
    </div>
